		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt504>=1 ) { break _loop504; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2593 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2593 = _t;
				synPredMatched2593 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2593 = false;
				}
				_t = __t2593;
inputState.guessing--;
			}
			if ( synPredMatched2593 ) {
				AST __t2594 = _t;
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2187>=1 ) { break _loop2187; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2023 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2023 = _t;
			synPredMatched2023 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2023 = false;
			}
			_t = __t2023;
inputState.guessing--;
		}
		if ( synPredMatched2023 ) {
...
inputState.guessing--;
		...
		if ( synPredMatched2307 ) {
			...
			boolean synPredMatched2309 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2309 = _t;
				synPredMatched2309 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2309 = false;
				}
				_t = __t2309;
inputState.guessing--;
			}
			if ( synPredMatched2309 ) {
