...
inputState.guessing--;
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt852>=1 ) { break _loop852; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt852++;
		} while (true);
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt501>=1 ) { break _loop501; } else {throw new NoViableAltException(_t);}
				}
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt643>=1 ) { break _loop643; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt693>=1 ) { break _loop693; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1678>=1 ) { break _loop1678; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt942>=1 ) { break _loop942; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt942++;
			} while (true);
...
inputState.guessing--;
		...
		_t = _retTree;
		{
		boolean synPredMatched991 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==PERIOD||_t.getType()==LEXCOLON))) {
			AST __t991 = _t;
			synPredMatched991 = true;
			inputState.guessing++;
			try {
				{
				block_colon(_t);
				...
				synPredMatched991 = false;
			}
			_t = __t991;
inputState.guessing--;
		}
		if ( synPredMatched991 ) {
			block_colon(_t);
			_t = _retTree;
			code_block(_t);
			_t = _retTree;
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1341>=1 ) { break _loop1341; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1341++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2584 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2584 = _t;
				synPredMatched2584 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2584 = false;
				}
				_t = __t2584;
inputState.guessing--;
			}
			if ( synPredMatched2584 ) {
				AST __t2585 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2173>=1 ) { break _loop2173; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2178>=1 ) { break _loop2178; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2211 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2211 = _t;
					synPredMatched2211 = true;
					inputState.guessing++;
					try {
						{
						AST __t2209 = _t;
						...
						synPredMatched2211 = false;
					}
					_t = __t2211;
inputState.guessing--;
				}
				if ( synPredMatched2211 ) {
					AST __t2212 = _t;
	...
	public final void case_expression(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1742 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OR))) {
			AST __t1742 = _t;
			synPredMatched1742 = true;
			inputState.guessing++;
			try {
				{
				AST __t1741 = _t;
				...
				synPredMatched1742 = false;
			}
			_t = __t1742;
inputState.guessing--;
		}
		if ( synPredMatched1742 ) {
			AST __t1743 = _t;
