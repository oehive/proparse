...
inputState.guessing--;
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1293>=1 ) { break _loop1293; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1371>=1 ) { break _loop1371; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void functionstate(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched1437 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==IN_KW))) {
				AST __t1437 = _t;
				synPredMatched1437 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1437 = false;
				}
				_t = __t1437;
inputState.guessing--;
			}
			if ( synPredMatched1437 ) {
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1521>=1 ) { break _loop1521; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1521++;
			} while (true);
...
inputState.guessing--;
	...
	public final void onstate(AST _t) throws RecognitionException {
		...
		_t = _t.getFirstChild();
		{
		boolean synPredMatched1656 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_15.member(_t.getType())))) {
			AST __t1656 = _t;
			synPredMatched1656 = true;
			inputState.guessing++;
			try {
				{
				if (_t==null) _t=ASTNULL;
				...
				synPredMatched1656 = false;
			}
			_t = __t1656;
inputState.guessing--;
		}
		if ( synPredMatched1656 ) {
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case CREATE:
...
inputState.guessing--;
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched1823 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t1823 = _t;
					synPredMatched1823 = true;
					inputState.guessing++;
					try {
						{
						AST __t1821 = _t;
						...
						synPredMatched1823 = false;
					}
					_t = __t1823;
inputState.guessing--;
				}
				if ( synPredMatched1823 ) {
					AST __t1824 = _t;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2242 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2242 = _t;
			synPredMatched2242 = true;
			inputState.guessing++;
			try {
				{
				AST __t2241 = _t;
				...
				synPredMatched2242 = false;
			}
			_t = __t2242;
inputState.guessing--;
		}
		if ( synPredMatched2242 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
...
inputState.guessing--;
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2411 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2411 = _t;
				synPredMatched2411 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2411 = false;
				}
				_t = __t2411;
inputState.guessing--;
			}
			if ( synPredMatched2411 ) {
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched2440 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t2440 = _t;
				synPredMatched2440 = true;
				inputState.guessing++;
				try {
					{
					AST __t2439 = _t;
					...
					synPredMatched2440 = false;
				}
				_t = __t2440;
inputState.guessing--;
			}
			if ( synPredMatched2440 ) {
				AST __t2441 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2375>=1 ) { break _loop2375; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2375++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2547 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2547 = _t;
				synPredMatched2547 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2547 = false;
				}
				_t = __t2547;
inputState.guessing--;
			}
			if ( synPredMatched2547 ) {
				AST __t2548 = _t;
