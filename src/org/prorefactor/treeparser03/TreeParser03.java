...
public TreeParser03() {
	...
	public final void blockorstate(AST _t) throws RecognitionException {
		...
		case ANNOTATION:
		{
			...
			do {
				if (_t==null) _t=ASTNULL;
				if (((_t.getType() >= LEXDATE && _t.getType() <= XMLNODENAME))) {
...
inputState.guessing--;
		...
		if ( synPredMatched2012 ) {
			...
			boolean synPredMatched2014 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2014 = _t;
				synPredMatched2014 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2014 = false;
				}
				_t = __t2014;
inputState.guessing--;
			}
			if ( synPredMatched2014 ) {
		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt638>=1 ) { break _loop638; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void choosestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==Form_item)) {
				...
				if ( _cnt704>=1 ) { break _loop704; } else {throw new NoViableAltException(_t);}
			}
			...
			case IMAGEDOWN:
			{
				...
				do {
					...
					if ((_tokenSet_14.member(_t.getType()))) {
						...
						if ( _cnt1099>=1 ) { break _loop1099; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGE:
			{
				...
				do {
					...
					if ((_tokenSet_14.member(_t.getType()))) {
						...
						if ( _cnt1102>=1 ) { break _loop1102; } else {throw new NoViableAltException(_t);}
					}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1168>=1 ) { break _loop1168; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1171>=1 ) { break _loop1171; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1459>=1 ) { break _loop1459; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1462>=1 ) { break _loop1462; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void onstate(AST _t) throws RecognitionException {
		...
		_t = _t.getFirstChild();
		{
		boolean synPredMatched1731 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_18.member(_t.getType())))) {
			AST __t1731 = _t;
			synPredMatched1731 = true;
			inputState.guessing++;
			try {
				{
				if (_t==null) _t=ASTNULL;
				...
				synPredMatched1731 = false;
			}
			_t = __t1731;
inputState.guessing--;
		}
		if ( synPredMatched1731 ) {
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case CREATE:
			...
			boolean synPredMatched1752 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType() >= LEXDATE && _t.getType() <= XMLNODENAME)))) {
				AST __t1752 = _t;
				synPredMatched1752 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1752 = false;
				}
				_t = __t1752;
inputState.guessing--;
			}
			if ( synPredMatched1752 ) {
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt1830>=1 ) { break _loop1830; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				match(_t,_tokenSet_23);
				_t = _t.getNextSibling();
				}
			}
			else {
				if ( _cnt1835>=1 ) { break _loop1835; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched1888 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t1888 = _t;
					synPredMatched1888 = true;
					inputState.guessing++;
					try {
						{
						AST __t1886 = _t;
						...
						synPredMatched1888 = false;
					}
					_t = __t1888;
inputState.guessing--;
				}
				if ( synPredMatched1888 ) {
					AST __t1889 = _t;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2271 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2271 = _t;
			synPredMatched2271 = true;
			inputState.guessing++;
			try {
				{
				AST __t2270 = _t;
				...
				synPredMatched2271 = false;
			}
			_t = __t2271;
inputState.guessing--;
		}
		if ( synPredMatched2271 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
...
inputState.guessing--;
		...
		do {
			...
			if ((_t.getType()==OBJCOLON||_t.getType()==DOUBLECOLON)) {
				...
				if ( _cnt526>=1 ) { break _loop526; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_42.member(_t.getType()))) {
					...
					if ( _cnt747>=1 ) { break _loop747; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt1483>=1 ) { break _loop1483; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt1483++;
		} while (true);
...
inputState.guessing--;
	...
	public final void menu_list_item(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1222 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==PERIOD))) {
			AST __t1222 = _t;
			synPredMatched1222 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched1222 = false;
			}
			_t = __t1222;
inputState.guessing--;
		}
		if ( synPredMatched1222 ) {
...
inputState.guessing--;
		...
		else if (((_t.getType() >= LEXDATE && _t.getType() <= XMLNODENAME))) {
		}
		else {
			throw new NoViableAltException(_t);
		}
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2425 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2425 = _t;
				synPredMatched2425 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2425 = false;
				}
				_t = __t2425;
inputState.guessing--;
			}
			if ( synPredMatched2425 ) {
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched2454 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t2454 = _t;
				synPredMatched2454 = true;
				inputState.guessing++;
				try {
					{
					AST __t2453 = _t;
					...
					synPredMatched2454 = false;
				}
				_t = __t2454;
inputState.guessing--;
			}
			if ( synPredMatched2454 ) {
				AST __t2455 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2389>=1 ) { break _loop2389; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2389++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2561 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2561 = _t;
				synPredMatched2561 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2561 = false;
				}
				_t = __t2561;
inputState.guessing--;
			}
			if ( synPredMatched2561 ) {
				AST __t2562 = _t;
