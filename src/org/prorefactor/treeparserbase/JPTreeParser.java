		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt490>=1 ) { break _loop490; } else {throw new NoViableAltException(_t);}
				}
			...
			case IMAGEDOWN:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt918>=1 ) { break _loop918; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt927>=1 ) { break _loop927; } else {throw new NoViableAltException(_t);}
					}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt992>=1 ) { break _loop992; } else {throw new NoViableAltException(_t);}
				}
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt1149>=1 ) { break _loop1149; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1218>=1 ) { break _loop1218; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1296>=1 ) { break _loop1296; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1374>=1 ) { break _loop1374; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1377>=1 ) { break _loop1377; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1524>=1 ) { break _loop1524; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1524++;
			} while (true);
	...
	public final void methodstate(AST _t) throws RecognitionException {
		...
		_t = _retTree;
		{
		boolean synPredMatched1638 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==PERIOD||_t.getType()==LEXCOLON))) {
			AST __t1638 = _t;
			synPredMatched1638 = true;
			inputState.guessing++;
			try {
				{
				block_colon(_t);
				...
				synPredMatched1638 = false;
			}
			_t = __t1638;
inputState.guessing--;
		}
		if ( synPredMatched1638 ) {
			block_colon(_t);
			_t = _retTree;
			code_block(_t);
			_t = _retTree;
	...
	public final void onstate(AST _t) throws RecognitionException {
		...
		_t = _t.getFirstChild();
		{
		boolean synPredMatched1659 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_15.member(_t.getType())))) {
			AST __t1659 = _t;
			synPredMatched1659 = true;
			inputState.guessing++;
			try {
				{
				if (_t==null) _t=ASTNULL;
				...
				synPredMatched1659 = false;
			}
			_t = __t1659;
inputState.guessing--;
		}
		if ( synPredMatched1659 ) {
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case CREATE:
			...
			boolean synPredMatched1680 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType() >= LEXDATE && _t.getType() <= Last_Token_Number)))) {
				AST __t1680 = _t;
				synPredMatched1680 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1680 = false;
				}
				_t = __t1680;
inputState.guessing--;
			}
			if ( synPredMatched1680 ) {
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched1826 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t1826 = _t;
					synPredMatched1826 = true;
					inputState.guessing++;
					try {
						{
						AST __t1824 = _t;
						...
						synPredMatched1826 = false;
					}
					_t = __t1826;
inputState.guessing--;
				}
				if ( synPredMatched1826 ) {
					AST __t1827 = _t;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2245 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2245 = _t;
			synPredMatched2245 = true;
			inputState.guessing++;
			try {
				{
				AST __t2244 = _t;
				...
				synPredMatched2245 = false;
			}
			_t = __t2245;
inputState.guessing--;
		}
		if ( synPredMatched2245 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_37.member(_t.getType()))) {
				...
				if ( _cnt380>=1 ) { break _loop380; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt609>=1 ) { break _loop609; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt609++;
		} while (true);
...
inputState.guessing--;
	...
	public final void defineparam_var(AST _t) throws RecognitionException {
		...
		if ((_t.getType()==AS)) {
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched1069 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==HANDLE))) {
				AST __t1069 = _t;
				synPredMatched1069 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1069 = false;
				}
				_t = __t1069;
inputState.guessing--;
			}
			if ( synPredMatched1069 ) {
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1956 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_4.member(_t.getType())))) {
			AST __t1956 = _t;
			synPredMatched1956 = true;
			inputState.guessing++;
			try {
				{
				AST __t1955 = _t;
				...
				synPredMatched1956 = false;
			}
			_t = __t1956;
inputState.guessing--;
		}
		if ( synPredMatched1956 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched1958 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t1958 = _t;
				synPredMatched1958 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1958 = false;
				}
				_t = __t1958;
inputState.guessing--;
			}
			if ( synPredMatched1958 ) {
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2414 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2414 = _t;
				synPredMatched2414 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2414 = false;
				}
				_t = __t2414;
inputState.guessing--;
			}
			if ( synPredMatched2414 ) {
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched2443 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t2443 = _t;
				synPredMatched2443 = true;
				inputState.guessing++;
				try {
					{
					AST __t2442 = _t;
					...
					synPredMatched2443 = false;
				}
				_t = __t2443;
inputState.guessing--;
			}
			if ( synPredMatched2443 ) {
				AST __t2444 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2378>=1 ) { break _loop2378; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2378++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2550 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2550 = _t;
				synPredMatched2550 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2550 = false;
				}
				_t = __t2550;
inputState.guessing--;
			}
			if ( synPredMatched2550 ) {
				AST __t2551 = _t;
