	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1713>=1 ) { break _loop1713; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1986 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t1986 = _t;
			synPredMatched1986 = true;
			inputState.guessing++;
			try {
				{
				AST __t1985 = _t;
				...
				synPredMatched1986 = false;
			}
			_t = __t1986;
inputState.guessing--;
		}
		if ( synPredMatched1986 ) {
			AST __t1987 = _t;
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1694>=1 ) { break _loop1694; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1357>=1 ) { break _loop1357; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1357++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2610 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2610 = _t;
				synPredMatched2610 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2610 = false;
				}
				_t = __t2610;
inputState.guessing--;
			}
			if ( synPredMatched2610 ) {
				AST __t2611 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2197>=1 ) { break _loop2197; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2202>=1 ) { break _loop2202; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2235 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2235 = _t;
					synPredMatched2235 = true;
					inputState.guessing++;
					try {
						{
						AST __t2233 = _t;
						...
						synPredMatched2235 = false;
					}
					_t = __t2235;
inputState.guessing--;
				}
				if ( synPredMatched2235 ) {
					AST __t2236 = _t;
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2033 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2033 = _t;
			synPredMatched2033 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2033 = false;
			}
			_t = __t2033;
inputState.guessing--;
		}
		if ( synPredMatched2033 ) {
