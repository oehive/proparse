...
inputState.guessing--;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2265 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2265 = _t;
			synPredMatched2265 = true;
			inputState.guessing++;
			try {
				{
				AST __t2264 = _t;
				...
				synPredMatched2265 = false;
			}
			_t = __t2265;
inputState.guessing--;
		}
		if ( synPredMatched2265 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2398>=1 ) { break _loop2398; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2398++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2570 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2570 = _t;
				synPredMatched2570 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2570 = false;
				}
				_t = __t2570;
inputState.guessing--;
			}
			if ( synPredMatched2570 ) {
				AST __t2571 = _t;
