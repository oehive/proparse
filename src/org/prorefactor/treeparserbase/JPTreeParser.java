		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt468>=1 ) { break _loop468; } else {throw new NoViableAltException(_t);}
				}
		...
		case USING:
		{
			...
			do {
				...
				if ((_t.getType()==Field_ref)) {
					...
					if ( _cnt493>=1 ) { break _loop493; } else {throw new NoViableAltException(_t);}
				}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_9.member(_t.getType()))) {
						...
						if ( _cnt930>=1 ) { break _loop930; } else {throw new NoViableAltException(_t);}
					}
			...
			if ((_t.getType()==INDEX)) {
				...
				do {
					...
					if ((_t.getType()==ID)) {
						...
						if ( _cnt1152>=1 ) { break _loop1152; } else {throw new NoViableAltException(_t);}
					}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1221>=1 ) { break _loop1221; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1300>=1 ) { break _loop1300; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1378>=1 ) { break _loop1378; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1528>=1 ) { break _loop1528; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1528++;
			} while (true);
	...
	public final void methodstate(AST _t) throws RecognitionException {
		...
		_t = _retTree;
		{
		boolean synPredMatched1642 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==PERIOD||_t.getType()==LEXCOLON))) {
			AST __t1642 = _t;
			synPredMatched1642 = true;
			inputState.guessing++;
			try {
				{
				block_colon(_t);
				...
				synPredMatched1642 = false;
			}
			_t = __t1642;
inputState.guessing--;
		}
		if ( synPredMatched1642 ) {
			block_colon(_t);
			_t = _retTree;
			code_block(_t);
			_t = _retTree;
...
inputState.guessing--;
		...
		if ( synPredMatched1663 ) {
			...
			boolean synPredMatched1684 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType() >= LEXDATE && _t.getType() <= Last_Token_Number)))) {
				AST __t1684 = _t;
				synPredMatched1684 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1684 = false;
				}
				_t = __t1684;
inputState.guessing--;
			}
			if ( synPredMatched1684 ) {
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt1762>=1 ) { break _loop1762; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched1830 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t1830 = _t;
					synPredMatched1830 = true;
					inputState.guessing++;
					try {
						{
						AST __t1828 = _t;
						...
						synPredMatched1830 = false;
					}
					_t = __t1830;
inputState.guessing--;
				}
				if ( synPredMatched1830 ) {
					AST __t1831 = _t;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2249 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2249 = _t;
			synPredMatched2249 = true;
			inputState.guessing++;
			try {
				{
				AST __t2248 = _t;
				...
				synPredMatched2249 = false;
			}
			_t = __t2249;
inputState.guessing--;
		}
		if ( synPredMatched2249 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_37.member(_t.getType()))) {
				...
				if ( _cnt383>=1 ) { break _loop383; } else {throw new NoViableAltException(_t);}
			}
		...
		case PFCOLOR:
		{
			...
			do {
				...
				if ((_tokenSet_40.member(_t.getType()))) {
					...
					if ( _cnt575>=1 ) { break _loop575; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1960 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_4.member(_t.getType())))) {
			AST __t1960 = _t;
			synPredMatched1960 = true;
			inputState.guessing++;
			try {
				{
				AST __t1959 = _t;
				...
				synPredMatched1960 = false;
			}
			_t = __t1960;
inputState.guessing--;
		}
		if ( synPredMatched1960 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
...
inputState.guessing--;
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2418 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2418 = _t;
				synPredMatched2418 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2418 = false;
				}
				_t = __t2418;
inputState.guessing--;
			}
			if ( synPredMatched2418 ) {
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched2447 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t2447 = _t;
				synPredMatched2447 = true;
				inputState.guessing++;
				try {
					{
					AST __t2446 = _t;
					...
					synPredMatched2447 = false;
				}
				_t = __t2447;
inputState.guessing--;
			}
			if ( synPredMatched2447 ) {
				AST __t2448 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2382>=1 ) { break _loop2382; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2382++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2554 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2554 = _t;
				synPredMatched2554 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2554 = false;
				}
				_t = __t2554;
inputState.guessing--;
			}
			if ( synPredMatched2554 ) {
				AST __t2555 = _t;
