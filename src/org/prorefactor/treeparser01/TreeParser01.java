	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1712>=1 ) { break _loop1712; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1985 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t1985 = _t;
			synPredMatched1985 = true;
			inputState.guessing++;
			try {
				{
				AST __t1984 = _t;
				...
				synPredMatched1985 = false;
			}
			_t = __t1985;
inputState.guessing--;
		}
		if ( synPredMatched1985 ) {
			AST __t1986 = _t;
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1693>=1 ) { break _loop1693; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2196>=1 ) { break _loop2196; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2201>=1 ) { break _loop2201; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2234 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2234 = _t;
					synPredMatched2234 = true;
					inputState.guessing++;
					try {
						{
						AST __t2232 = _t;
						...
						synPredMatched2234 = false;
					}
					_t = __t2234;
inputState.guessing--;
				}
				if ( synPredMatched2234 ) {
					AST __t2235 = _t;
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2321 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2321 = _t;
			synPredMatched2321 = true;
			inputState.guessing++;
			try {
				{
				AST __t2320 = _t;
				...
				synPredMatched2321 = false;
			}
			_t = __t2321;
inputState.guessing--;
		}
		if ( synPredMatched2321 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
