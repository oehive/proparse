		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1299>=1 ) { break _loop1299; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt1380>=1 ) { break _loop1380; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1527>=1 ) { break _loop1527; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1527++;
			} while (true);
...
inputState.guessing--;
	...
	public final void onstate(AST _t) throws RecognitionException {
		...
		_t = _t.getFirstChild();
		{
		boolean synPredMatched1662 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_15.member(_t.getType())))) {
			AST __t1662 = _t;
			synPredMatched1662 = true;
			inputState.guessing++;
			try {
				{
				if (_t==null) _t=ASTNULL;
				...
				synPredMatched1662 = false;
			}
			_t = __t1662;
inputState.guessing--;
		}
		if ( synPredMatched1662 ) {
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case CREATE:
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt1766>=1 ) { break _loop1766; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void updatestatement(AST _t) throws RecognitionException {
		...
		boolean synPredMatched2248 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==UPDATE))) {
			AST __t2248 = _t;
			synPredMatched2248 = true;
			inputState.guessing++;
			try {
				{
				AST __t2247 = _t;
				...
				synPredMatched2248 = false;
			}
			_t = __t2248;
inputState.guessing--;
		}
		if ( synPredMatched2248 ) {
			sqlupdatestate(_t);
			_t = _retTree;
		}
...
inputState.guessing--;
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt1401>=1 ) { break _loop1401; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt1401++;
		} while (true);
...
inputState.guessing--;
	...
	public final void selectstatea(AST _t) throws RecognitionException {
		...
		case Sql_select_what:
		{
			...
			_t = _t.getFirstChild();
			{
			boolean synPredMatched2417 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2417 = _t;
				synPredMatched2417 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2417 = false;
				}
				_t = __t2417;
inputState.guessing--;
			}
			if ( synPredMatched2417 ) {
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched2446 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t2446 = _t;
				synPredMatched2446 = true;
				inputState.guessing++;
				try {
					{
					AST __t2445 = _t;
					...
					synPredMatched2446 = false;
				}
				_t = __t2446;
inputState.guessing--;
			}
			if ( synPredMatched2446 ) {
				AST __t2447 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2381>=1 ) { break _loop2381; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2381++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2553 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2553 = _t;
				synPredMatched2553 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2553 = false;
				}
				_t = __t2553;
inputState.guessing--;
			}
			if ( synPredMatched2553 ) {
				AST __t2554 = _t;
