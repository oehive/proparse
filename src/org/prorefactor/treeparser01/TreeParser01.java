...
inputState.guessing--;
	...
	public final void formatphrase(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt857>=1 ) { break _loop857; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt857++;
		} while (true);
	...
	public final void columnformat(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
			{
				if ( _cnt295>=1 ) { break _loop295; } else {throw new NoViableAltException(_t);}
			}
			}
			_cnt295++;
		} while (true);
	...
	public final void assign_opt(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==EQUAL)) {
				...
				if ( _cnt1701>=1 ) { break _loop1701; } else {throw new NoViableAltException(_t);}
			}
			...
			case IMAGEDOWN:
			{
				...
				do {
					...
					if ((_tokenSet_12.member(_t.getType()))) {
						...
						if ( _cnt428>=1 ) { break _loop428; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEUP:
			{
				...
				do {
					...
					if ((_tokenSet_12.member(_t.getType()))) {
						...
						if ( _cnt434>=1 ) { break _loop434; } else {throw new NoViableAltException(_t);}
					}
			...
			case IMAGEINSENSITIVE:
			{
				...
				do {
					...
					if ((_tokenSet_12.member(_t.getType()))) {
						...
						if ( _cnt437>=1 ) { break _loop437; } else {throw new NoViableAltException(_t);}
					}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt503>=1 ) { break _loop503; } else {throw new NoViableAltException(_t);}
				}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt695>=1 ) { break _loop695; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1682>=1 ) { break _loop1682; } else {throw new NoViableAltException(_t);}
			}
		...
		case Form_item:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt763>=1 ) { break _loop763; } else {throw new NoViableAltException(_t);}
				}
		...
		case HEADER:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt833>=1 ) { break _loop833; } else {throw new NoViableAltException(_t);}
				}
		...
		case BACKGROUND:
		{
			...
			do {
				...
				if ((_t.getType()==Form_item)) {
					...
					if ( _cnt836>=1 ) { break _loop836; } else {throw new NoViableAltException(_t);}
				}
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1346>=1 ) { break _loop1346; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1346++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2591 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2591 = _t;
				synPredMatched2591 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2591 = false;
				}
				_t = __t2591;
inputState.guessing--;
			}
			if ( synPredMatched2591 ) {
				AST __t2592 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2180>=1 ) { break _loop2180; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2185>=1 ) { break _loop2185; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2218 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2218 = _t;
					synPredMatched2218 = true;
					inputState.guessing++;
					try {
						{
						AST __t2216 = _t;
						...
						synPredMatched2218 = false;
					}
					_t = __t2218;
inputState.guessing--;
				}
				if ( synPredMatched2218 ) {
					AST __t2219 = _t;
	...
	public final void case_expression(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1746 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OR))) {
			AST __t1746 = _t;
			synPredMatched1746 = true;
			inputState.guessing++;
			try {
				{
				AST __t1745 = _t;
				...
				synPredMatched1746 = false;
			}
			_t = __t1746;
inputState.guessing--;
		}
		if ( synPredMatched1746 ) {
			AST __t1747 = _t;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2021 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2021 = _t;
			synPredMatched2021 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2021 = false;
			}
			_t = __t2021;
inputState.guessing--;
		}
		if ( synPredMatched2021 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2305 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2305 = _t;
			synPredMatched2305 = true;
			inputState.guessing++;
			try {
				{
				AST __t2304 = _t;
				...
				synPredMatched2305 = false;
			}
			_t = __t2305;
inputState.guessing--;
		}
		if ( synPredMatched2305 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
