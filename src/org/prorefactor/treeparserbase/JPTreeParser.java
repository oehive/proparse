	...
	public final void importstate(AST _t) throws RecognitionException {
		...
		case Field_ref:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1529>=1 ) { break _loop1529; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1529++;
			} while (true);
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt1774>=1 ) { break _loop1774; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched1967 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_4.member(_t.getType())))) {
			AST __t1967 = _t;
			synPredMatched1967 = true;
			inputState.guessing++;
			try {
				{
				AST __t1966 = _t;
				...
				synPredMatched1967 = false;
			}
			_t = __t1967;
inputState.guessing--;
		}
		if ( synPredMatched1967 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched1969 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t1969 = _t;
				synPredMatched1969 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched1969 = false;
				}
				_t = __t1969;
inputState.guessing--;
			}
			if ( synPredMatched1969 ) {
...
inputState.guessing--;
		...
		if (((_t.getType()==3||_t.getType()==UNION||_t.getType()==WITH))&&(_t != null)) {
			{
			boolean synPredMatched2456 = false;
			if (_t==null) _t=ASTNULL;
			if ((((_t.getType()==WITH))&&(_t != null))) {
				AST __t2456 = _t;
				synPredMatched2456 = true;
				inputState.guessing++;
				try {
					{
					AST __t2455 = _t;
					...
					synPredMatched2456 = false;
				}
				_t = __t2456;
inputState.guessing--;
			}
			if ( synPredMatched2456 ) {
				AST __t2457 = _t;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2391>=1 ) { break _loop2391; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt2391++;
			} while (true);
