	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1685>=1 ) { break _loop1685; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2601 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2601 = _t;
				synPredMatched2601 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2601 = false;
				}
				_t = __t2601;
inputState.guessing--;
			}
			if ( synPredMatched2601 ) {
				AST __t2602 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2188>=1 ) { break _loop2188; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2193>=1 ) { break _loop2193; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2226 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2226 = _t;
					synPredMatched2226 = true;
					inputState.guessing++;
					try {
						{
						AST __t2224 = _t;
						...
						synPredMatched2226 = false;
					}
					_t = __t2226;
inputState.guessing--;
				}
				if ( synPredMatched2226 ) {
					AST __t2227 = _t;
	...
	public final void case_expression(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1749 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OR))) {
			AST __t1749 = _t;
			synPredMatched1749 = true;
			inputState.guessing++;
			try {
				{
				AST __t1748 = _t;
				...
				synPredMatched1749 = false;
			}
			_t = __t1749;
inputState.guessing--;
		}
		if ( synPredMatched1749 ) {
			AST __t1750 = _t;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2024 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2024 = _t;
			synPredMatched2024 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2024 = false;
			}
			_t = __t2024;
inputState.guessing--;
		}
		if ( synPredMatched2024 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2313 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2313 = _t;
			synPredMatched2313 = true;
			inputState.guessing++;
			try {
				{
				AST __t2312 = _t;
				...
				synPredMatched2313 = false;
			}
			_t = __t2313;
inputState.guessing--;
		}
		if ( synPredMatched2313 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
