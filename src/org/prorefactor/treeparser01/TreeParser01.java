...
inputState.guessing--;
	...
	public final void display_with(AST _t) throws RecognitionException {
		...
		boolean synPredMatched1984 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==WITH))) {
			AST __t1984 = _t;
			synPredMatched1984 = true;
			inputState.guessing++;
			try {
				{
				AST __t1983 = _t;
				...
				synPredMatched1984 = false;
			}
			_t = __t1984;
inputState.guessing--;
		}
		if ( synPredMatched1984 ) {
			AST __t1985 = _t;
	...
	public final void aggregatephrase(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_tokenSet_21.member(_t.getType()))) {
				...
				if ( _cnt1692>=1 ) { break _loop1692; } else {throw new NoViableAltException(_t);}
			}
...
inputState.guessing--;
	...
	public final void grant_rev_opt(AST _t) throws RecognitionException {
		...
		case COMMA:
		{
			...
			do {
				...
				default:
				{
					if ( _cnt1356>=1 ) { break _loop1356; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt1356++;
			} while (true);
	...
	public final void sqlscalar(AST _t) throws RecognitionException {
		...
		default:
			boolean synPredMatched2608 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==LEFTPAREN))) {
				AST __t2608 = _t;
				synPredMatched2608 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2608 = false;
				}
				_t = __t2608;
inputState.guessing--;
			}
			if ( synPredMatched2608 ) {
				AST __t2609 = _t;
	...
	public final void oscreatedirstate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE||_t.getType()==TYPELESS_TOKEN)) {
				...
				if ( _cnt2195>=1 ) { break _loop2195; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void osdeletestate(AST _t) throws RecognitionException {
		...
		do {
			...
			if ((_t.getType()==VALUE)) {
				...
				if ( _cnt2200>=1 ) { break _loop2200; } else {throw new NoViableAltException(_t);}
			}
	...
	public final void putstate(AST _t) throws RecognitionException {
		...
		do {
			...
			default:
				boolean synPredMatched2233 = false;
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==NULL_KW))) {
					AST __t2233 = _t;
					synPredMatched2233 = true;
					inputState.guessing++;
					try {
						{
						AST __t2231 = _t;
						...
						synPredMatched2233 = false;
					}
					_t = __t2233;
inputState.guessing--;
				}
				if ( synPredMatched2233 ) {
					AST __t2234 = _t;
...
inputState.guessing--;
	...
	public final void goon_elem(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2031 = false;
		if (_t==null) _t=ASTNULL;
		if (((_t.getType()==OF))) {
			AST __t2031 = _t;
			synPredMatched2031 = true;
			inputState.guessing++;
			try {
				{
				...
				synPredMatched2031 = false;
			}
			_t = __t2031;
inputState.guessing--;
		}
		if ( synPredMatched2031 ) {
	...
	public final void return_options(AST _t) throws RecognitionException {
		...
		{
		boolean synPredMatched2320 = false;
		if (_t==null) _t=ASTNULL;
		if (((_tokenSet_3.member(_t.getType())))) {
			AST __t2320 = _t;
			synPredMatched2320 = true;
			inputState.guessing++;
			try {
				{
				AST __t2319 = _t;
				...
				synPredMatched2320 = false;
			}
			_t = __t2320;
inputState.guessing--;
		}
		if ( synPredMatched2320 ) {
			expression(_t);
			_t = _retTree;
		}
		else {
			boolean synPredMatched2322 = false;
			if (_t==null) _t=ASTNULL;
			if (((_t.getType()==ERROR))) {
				AST __t2322 = _t;
				synPredMatched2322 = true;
				inputState.guessing++;
				try {
					{
					...
					synPredMatched2322 = false;
				}
				_t = __t2322;
inputState.guessing--;
			}
			if ( synPredMatched2322 ) {
