...
public interface TreeParser03TokenTypes {
	...
	int Last_Token_Number = 1163;
	int BOX = 1164;
	int DBREMOTEHOST = 1165;
	int DYNAMICCAST = 1166;
	int UNBOX = 1167;
	int CATCH = 1168;
	int STATIC = 1169;
	int LIKESEQUENTIAL = 1170;
	int FINALLY = 1171;
	int THROW = 1172;
	int ROUTINELEVEL = 1173;
	int STREAMHANDLE = 1174;
	int ASSEMBLY = 1175;
	int XMLNODENAME = 1176;
}
